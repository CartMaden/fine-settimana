/* ============================================================
   calendario_bracket.js — Torneo a Punti (Swiss)
   Widget inline per mostrare i risultati del torneo nel calendario.
   Supporta turni multipli e classifica live.
   ============================================================ */
    ...
    function render(data) {
        ...
        if (savedAt) {
            html += `<div class="cal-bracket-meta">
                <span class="cal-bracket-label">⚔️ Torneo a Punti — ${bracket.length} Turni Giocati</span>
        ...
        if (leaderboard.length > 0) {
            ...
            leaderboard.forEach((team, i) => {
                ...
                const isTop = i === 0;
                html += `<div class="cal-lb-row${isTop ? " cal-lb-row--top" : ""}">
        ...
        bracket.forEach((round, rIdx) => {
            ...
            html += `<div class="cal-round-block">
                <div class="cal-round-header">
                    ...
                    <span class="cal-round-badge ${isComplete ? "cal-badge--done" : played > 0 ? "cal-badge--partial" : "cal-badge--pending"}">
                        ${isComplete ? "✓ Completato" : played > 0 ? `${played}/${total}` : "In attesa"}
                    </span>
                </div>
            ...
            round.forEach((match, mIdx) => {
                ...
                const t1Win  = isDone && winner.caposquadra === t1.caposquadra;
                const t2Win  = isDone && winner.caposquadra === t2.caposquadra;

                html += `<div class="cal-match ${isDone ? "cal-match--done" : "cal-match--pending"}">
